...
/** ************************************************************************************************
 * This namespace of the A-Worx Library holds classes that are implementing container types.
 **************************************************************************************************/
namespace containers
{

/** ************************************************************************************************
 * This struct is used as the default implementation of a helper type of class
 * \ref aworx::lib::containers::StringTree "StringTree".
 ...
 *
 * This default implementation simply allocates the memory using \c new and copies the data.
 * The interface of methods #allocate and #free provide the value of the node. There might
 * be implementations where the value has already a copy of the child name allocated (or wishes
 * to do). In this case, that string can be returned.
 *
 * See also
 * \ref aworx::lib::containers::StringTreeConstKeyAllocator "StringTreeConstKeyAllocator".
 *
 * @tparam T      The value type of elements stored in the nodes of the tree.
 **************************************************************************************************/
template<typename T> struct StringTreeDefaultKeyAllocator
{
    /**
     ...
     */
    static void free( String& childName, T& value )
    {
        (void) value;
...
/** ************************************************************************************************
 * Implementation of
 * \ref aworx::lib::containers::StringTreeDefaultKeyAllocator "StringTreeDefaultKeyAllocator"
 * which does not allocated keys. The original buffer is just returned.
 *
 * This helper can be used in cases when child names and creation path strings used with
 * \ref aworx::lib::containers::StringTree "StringTree" and especially with the node creation methods
 * of class
 * \ref aworx::lib::containers::StringTree::Cursor "StringTree::Cursor" are safely allocated
 * already. This is for example true in the trivial case of using literal strings for child
 * creation.
 *
 * @tparam T      The value type of elements stored in the nodes of the tree.
 **************************************************************************************************/
template<typename T> struct StringTreeConstKeyAllocator
{
     ...
     */
    static String allocate( const String& childName, T& )
    {
        return childName;
    }
 ...
 * \ref aworx::lib::containers::StringTree::Node "Node", which consists of
 ...
 * Those are:
 * - \ref aworx::lib::containers::StringTree::Cursor       "Cursor",
 * - \ref aworx::lib::containers::StringTree::StdIterator  "StdIterator" (C++ version only) and
 * - \ref aworx::lib::containers::StringTree::Walker       "Walker".
 *
 ...
 * \ref aworx::lib::containers::StringTree::Cursor "Cursor". The only way to create an
 ...
 * - \ref aworx::lib::containers::StringTree::Cursor::MoveToChild        "Cursor::MoveToChild",
 * - \ref aworx::lib::containers::StringTree::Cursor::MoveToParent       "Cursor::MoveToParent",
 * - \ref aworx::lib::containers::StringTree::Cursor::MoveTo             "Cursor::MoveTo" and
 * - \ref aworx::lib::containers::StringTree::Cursor::MoveToExistingPart "Cursor::MoveToExistingPart".
 *
 * For the creation of new child nodes or a complete path of such, methods
 * - \ref aworx::lib::containers::StringTree::Cursor::MoveToChildCreate              "Cursor::MoveToChildCreate" and
 * - \ref aworx::lib::containers::StringTree::Cursor::MoveToAndCreateNonExistingPart "Cursor::MoveToAndCreateNonExistingPart"
 *
 * are provided. Then, two methods for erasing nodes exist:
 * - \ref aworx::lib::containers::StringTree::Cursor::DeleteChild    "Cursor::DeleteChild" and
 * - \ref aworx::lib::containers::StringTree::Cursor::DeleteChildren "Cursor::DeleteChildren"
 *
 ...
 * - \ref aworx::lib::containers::StringTree::Cursor::MoveToParentUnchecked "Cursor::MoveToParentUnchecked" and
 * - \ref aworx::lib::containers::StringTree::Cursor::IsValid               "Cursor::IsValid".
 *
 ...
 * \ref aworx::lib::containers::StringTree::StdIterator "StdIterator". It implements the concept
 * [C++ InputIterator](http://en.cppreference.com/w/cpp/concept/InputIterator) and due to the
 * implementation of methods
 * - \ref aworx::lib::containers::StringTree::begin "StringTree::begin" and
 * - \ref aworx::lib::containers::StringTree::end   "StringTree::end",
 *
 ...
 *
 * With methods
 * - \ref aworx::lib::containers::StringTree::Cursor::begin "Cursor::begin" and
 * - \ref aworx::lib::containers::StringTree::Cursor::end   "Cursor::end",
 *
 ...
 *
 * - \ref aworx::lib::containers::StringTree::Cursor::SetIterator   "Cursor::SetIterator" and
 * - \ref aworx::lib::containers::StringTree::Walker::SetIterator   "Walker::SetIterator".
 *
 * Please also note the paragraph about recursive iteration below.
 *
 * Class \ref aworx::lib::containers::StringTree::StdIterator "StdIterator" is quite lightweight.
 ...
 * Finally, with
 * \ref aworx::lib::containers::StringTree::Walker "Walker", a third \b %StdIterator class is exposed.
 ...
 *   \ref aworx::lib::containers::StringTree::Cursor   "Cursor"   objects and from
 *   \ref aworx::lib::containers::StringTree::StdIterator "StdIterator" objects.
 ...
 * same as class
 * \ref aworx::lib::containers::StringTree::Cursor "Cursor" does not - but then unlike class
 * \ref aworx::lib::containers::StringTree::StdIterator "StdIterator" which does!
 *
 ...
 * \ref aworx::lib::containers::StringTree::StdIterator   "StdIterator" and class
 * \ref aworx::lib::containers::StringTree::Walker     "Walker", allow recursive iteration. There are
 ...
 * \ref aworx::lib::containers::StringTree::Cursor "Cursor",
 * \ref aworx::lib::containers::StringTree::StdIterator "StdIterator" and
 * \ref aworx::lib::containers::StringTree::Walker "Walker") may become invalid when
 ...
 * \p StringTreeDefaultKeyAllocator is given which defaults to struct
 * \ref aworx::lib::containers::StringTreeDefaultKeyAllocator "StringTreeDefaultKeyAllocator", which
 ...
 * \ref aworx::lib::containers::StringTreeConstKeyAllocator "StringTreeConstKeyAllocator" may be used,
 ...
 * been removed from the tree, so that the key memory can safely deallocated.
 *
 * @tparam T              The value type of elements stored in the nodes of the tree.
 * @tparam TKeyAllocator  Type with static allocation methods as defined in default struct
 *                        \ref aworx::lib::containers::StringTreeDefaultKeyAllocator "StringTreeDefaultKeyAllocator".
 * @tparam TSeparator     The separation character used with cursor paths.
 **************************************************************************************************/
template<typename T,
         typename TKeyAllocator= StringTreeDefaultKeyAllocator<T>,
         char     TSeparator   = '/'
        >
class StringTree
{
    ...
    protected:
        ...
        /** Alias to a map of nodes with string keys  */
        using TMap=     std::unordered_map< aworx::String, Node*,
         ...
         * \ref aworx::lib::containers::StringTree::Cursor "Cursor", which represents node objects,
        ...
        struct Node
        {
            ...
            Node* getChild( const String& childName )
            {
                ...
                {
                    ALIB_WARNING( "Illegal child name {!Q}.", childName );
                    return nullptr;
                }
             ...
             */
            Node* createChildNoCheck( const String& childName )
            {
                Node* child= new Node( this ); // create child first, as we are using its name object as key.

                ALIB_DEBUG_CODE( auto result= )
                children.emplace( TKeyAllocator::allocate( childName, child->value ), child );
                ALIB_ASSERT_ERROR( result.second, "Internal error. Replacing child node." )
                return child;
            }
             ...
             */
            Node* createChild( const String& childName )
            {
                ALIB_ASSERT_ERROR( childName.Length() > 0           , "Can note create unnamed node");
             ...
             */
            std::pair<Node*, bool>  getOrCreateChild( const String& childName )
            {
             ...
             * Key strings are deallocated after the child is removed from the map using template
             * type TKeyAllocator.
             * @param  childName The name of the child
             * @return \c true if the child was found and deleted, \c false otherwise.
             */
            bool  deleteChild( const String& childName )
            {
                auto it= children.find( childName );
                if( it == children.end() )
                    return false;
                ...
                children.erase( it );
                TKeyAllocator::free( key, child->value );
                delete child;
                return true;
            }
             ...
             * from the map before the node structs and the key strings are delete.
             * Key strings are deallocated using template type TKeyAllocator
             */
            void deleteChildren()
            {
                ...
                {
                    TKeyAllocator::free( childNames[i], childObjects[i]->value );
    ...
    public:
         ...
         * \ref aworx::lib::containers::StringTree::Walker "StringTree::Walker" provides. Hence it is
         * much more lightweight than class \b %Walker.<br>
         * Its primary use is for algorithms that just need to 'visit' all nodes of the \b %StringTree
         * (or a branch of it), regardless of the order. Hence, it is typically used in
         * <em>range-for-loops</em> with <b>std::for_each</b>. This is why
         * methods #begin and #end of class \b %StringTree return a \b %StdIterator of this class type.
         *
        ...
        class StdIterator  : public std::iterator<std::input_iterator_tag, T>
        {
            ...
            struct RecursionDataIt
            {
                ...
                typename TMap::const_iterator   actChild;
            };
            ...
            protected:
                ...
                Node* actNode()
                {
                    ALIB_ASSERT_ERROR( !stack.empty(), "Invalid iterator")
            ...
            public:
                 ...
                 * \ref aworx::lib::containers::StringTree::Cursor::Depth "Cursor::Depth".
                 *
    ...
    public:
        ...
        class Cursor
        {
            ...
            protected:
                ...
                Node* followPath( Node* node, Substring& path )
                {
                    ...
                    for(;;)
                    {
                        ...
                        String name=  String( path, 0, path.IndexOfOrLength( TSeparator ) );
                ...
                Node* createPathAndReturnLeaf( Node* node, Substring& path )
                {
                    ...
                    for(;;)
                    {
                        ...
                        // get next name
                        String childName= String( path, 0, path.IndexOfOrLength( TSeparator ) );
                        ...
                        if( isFirst )
                        {
                            child= node->createChild( childName );
                            if( child == nullptr )
                                return nullptr;
                        }
                        else
            ...
            //####  Tree navigation inplace, returning status      #################################
                 ...
                 *    \snippet "src.cpp/alib/containers/stringtree.hpp"     DOX_ALIB_STRING_TREE_MOVETOPARENT
                 *    As can be seen, this sample also uses non-checking versions of the
                 *    insertion methods of class \ref aworx::lib::strings::AString "AString" because
                ...
                {
                    auto result= node->getOrCreateChild( childName );
                    if( node == nullptr )
                        return false;
                    node=   result.first;
                ...
                {
                    Substring consumable(path);
                    node= followPath( node, consumable );
                    return consumable;
                }
                ...
                {
                    auto rest= MoveToExistingPart( path );
                    if( rest.IsEmpty() )
                        return false;
                    node= createPathAndReturnLeaf( node, rest );
                    return true;
                }
            ...
            //####  Node deletion         ##########################################################
                ...
                {
                    return node->deleteChild( childName );
                }
            ...
            //####  StdIterator creation       ########################################################
                 ...
                 * Unlike with method
                 * \ref aworx::lib::containers::StringTree::begin "StringTree::begin", here the
...
//! [DOX_ALIB_STRING_TREE_MOVETOPARENT]
         ...
         * \ref aworx::lib::containers::StringTree::StdIterator "StdIterator" for a variant that does).
        ...
        class Walker
        {
            ...
            protected:
                ...
                struct Sorter
                {
                                      ...
                                      const std::pair<String,Node*>& rhs )
                    {
                        ...
                        int compResult= lhs.first.CompareTo( rhs.first, sortSensitivity );
                ...
                Node* actNode()
                {
                    ALIB_ASSERT_ERROR( IsValid(), "Invalid walker")
            ...
            public:
                ...
                {
                    ALIB_ASSERT_ERROR( stringTree == cursor.stringTree, "Differnt referred StringTree objects" );
                ...
                {
                    ALIB_ASSERT_ERROR( stringTree == it.stringTree, "Differnt referred StringTree objects" );
                    setStart( it.actNode() );
                }
                ...
                {
                    ALIB_ASSERT_ERROR( stringTree == other.stringTree, "Differnt referred StringTree objects" );
                 ...
                 * \ref aworx::lib::strings::String::Equals "String::Equals".
                 *
                ...
                {
                    ALIB_ASSERT_ERROR( IsValid(), "Invalid iterator")
                 ...
                 *
                 * \note Unlike method
                 *       \ref aworx::lib::containers::StringTree::Cursor::SearchName "Cursor::SearchName"
 ...
 */
template<typename T>
typename StringTree<T>::StdIterator begin(StringTree<T>& stringTree )
{
 ...
 */
template<typename T>
typename StringTree<T>::StdIterator end(StringTree<T>&   stringTree )
{
 ...
 */
template<typename T>
typename StringTree<T>::StdIterator begin(typename StringTree<T>::Cursor& cursor )
{
    return cursor.begin();
}
 ...
 */
template<typename T>
typename StringTree<T>::StdIterator end(typename StringTree<T>::Cursor&   cursor )
{
    return cursor.end();
}
...
template<typename T, typename TKeyAllocator= aworx::lib::containers::StringTreeDefaultKeyAllocator<T>>
using  StringTree=    aworx::lib::containers::StringTree<T, TKeyAllocator>;
