...
#if !defined(ALIB_PROPER_INCLUSION) || defined(HPP_ALIB_LANG_DBGASSERT)
    #error "include alib/alib.hpp instead of this header"
#endif

#ifndef HPP_ALIB_LANG_DBGASSERT
#define HPP_ALIB_LANG_DBGASSERT 1
