...
class WildcardMatcher
{
    ...
    public:
         ...
         ******************************************************************************************/
        inline
        WildcardMatcher( const String& pattern= NullString )
        {
            Compile( pattern );
        }
    ...
    public:
         ...
         ******************************************************************************************/
        ALIB_API
        bool   Match( const String& haystack, Case sensitivity = Case::Sensitive  );
...
using     WildcardMatcher=     aworx::lib::strings::util::WildcardMatcher;
