...
// include guard
#ifndef HPP_ALIB_STRINGS_FORMATTER_STD_IMPL
#define HPP_ALIB_STRINGS_FORMATTER_STD_IMPL 1
 ...
 * \ref aworx::lib::strings::Formatter::format "Formatter::format" and introduces a set of
 ...
 *   \ref aworx::lib::strings::FormatterPythonStyle "FormatterPythonStyle" as the
 *   "Python format mini language" supports such custom format specifications. Class
 *   \ref aworx::lib::strings::FormatterJavaStyle "FormatterJavaStyle" does \b not support
 *   this mechanism.
 *
 ...
 *     substring in field
 *     \ref aworx::lib::strings::FormatterStdImpl::phaFormatSpec "phaFormatSpec".
 *
 ...
 *       set fields
 *       \ref aworx::lib::strings::FormatterStdImpl::phaArgument    "phaArgument" and
 *       \ref aworx::lib::strings::FormatterStdImpl::phaArgumentIdx "phaArgumentIdx"
...
class FormatterStdImpl : public Formatter
{
    ...
    protected:
         ...
         *  This is set to
         *  \ref aworx::lib::strings::FormatterStdImpl::PHType::NotGiven "PHType::NotGiven"
    ...
    protected:
         ...
         * \ref aworx::lib::strings::FormatterStdImpl::phaArgument "phaArgument"
         ...
         * \ref aworx::lib::strings::FormatterStdImpl::phaArgument    "Argument" and
         * \ref aworx::lib::strings::FormatterStdImpl::phaArgumentIdx "ArgumentIdx"
         * in given \p field.
...
#endif // HPP_ALIB_STRINGS_FORMATTER_STD_IMPL
