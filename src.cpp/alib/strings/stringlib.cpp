...
#if !defined (HPP_ALIB_STRINGS_STRING_LIB)
#   include "strings.hpp"
#endif
...
/** ************************************************************************************************
This is namespace documentation includes a lengthy introduction and manual section.<br>
...
Often, some constant string data is needed. By having this field of type \c %String, just any string type can be
assigned to it, especially string literals of-course.
In advantage to type <em>const char*</em>, along with the pointer, the length of
the string is stored. This gives a good performance improvement, as e.g. no \e strlen() call
has to be made prior to copying a string to some other place.<br>

Same as with a use of <em>const char*</em>, when assigning a string to an \c String
object, it has to be made sure that this string is kept intact during the life-time of
the target.
...
\note If it is rather expected that a preallocated string gets replaced by a dynamically allocated
      buffer, then such warnings can be disabled using macro:
...
//! [DOX_ALIB_BOXING_SAMPLE_TEMPLATED_INTERFACE]
    aworx::lib::boxing::DefineInterface<bool      , false, boxing::IApply_TApplicable<bool      >>();
    aworx::lib::boxing::DefineInterface<char      , false, boxing::IApply_TApplicable<char      >>();
    aworx::lib::boxing::DefineInterface<wchar_t   , false, boxing::IApply_TApplicable<wchar_t   >>();
    aworx::lib::boxing::DefineInterface<char16_t  , false, boxing::IApply_TApplicable<char16_t  >>();
    aworx::lib::boxing::DefineInterface<char32_t  , false, boxing::IApply_TApplicable<char32_t  >>();
    aworx::lib::boxing::DefineInterface<boxed_int , false, boxing::IApply_TApplicable<boxed_int >>();
    aworx::lib::boxing::DefineInterface<boxed_uint, false, boxing::IApply_TApplicable<boxed_uint>>();
    aworx::lib::boxing::DefineInterface<double    , false, boxing::IApply_TApplicable<double    >>();
//! [DOX_ALIB_BOXING_SAMPLE_TEMPLATED_INTERFACE]

            aworx::lib::boxing::DefineInterface<char              , true  , boxing::IApply_TcharArr    >();
            aworx::lib::boxing::DefineInterface<wchar_t           , true  , boxing::IApply_Twchar_tArr >();
            aworx::lib::boxing::DefineInterface<char16_t          , true  , boxing::IApply_Tchar16_tArr>();
            aworx::lib::boxing::DefineInterface<char32_t          , true  , boxing::IApply_Tchar32_tArr>();
            aworx::lib::boxing::DefineInterface<BoxedAs<AString>  , false , boxing::IApply_BoxedAs_TApplicable<AString>>();
...
//! [DOX_ALIB_ENUM_META_DATA_SPECIFCATION_using_enum3]
        ...
        // initialize static spaces string
        Spaces::Initialize( 128 );
    }
}
