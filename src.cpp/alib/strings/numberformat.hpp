...
class NumberFormat
{
     ...
     */
    ALIB_API static     NumberFormat   Global;
     ...
     * value for parameters of their interface methods.
     */
    ALIB_API static     NumberFormat   Computational;
     ...
     **********************************************************************************************/
    inline   NumberFormat() { SetComputational(); }
     ...
     **********************************************************************************************/
    ALIB_API  void    Set( NumberFormat* other =nullptr );
    ...
    ALIB_API
    static
    uint64_t  ParseDecDigits( const String& src, integer& idx );
     ...
     **********************************************************************************************/
    ALIB_API
    int64_t   ParseInt( const String& src, integer& idx );
     ...
     **********************************************************************************************/
    ALIB_API
    uint64_t  ParseDec( const String& src, integer& idx );
     ...
     **********************************************************************************************/
    ALIB_API
    uint64_t  ParseBin( const String& src, integer& idx );
     ...
     **********************************************************************************************/
    ALIB_API
    uint64_t  ParseHex( const String& src, integer& idx );
     ...
     **********************************************************************************************/
    ALIB_API
    uint64_t  ParseOct( const String& src, integer& idx );
     ...
     **********************************************************************************************/
    ALIB_API
    double ParseFloat( const String& src, integer& idx );
     ...
     **********************************************************************************************/
    ALIB_API
    integer  WriteDecSigned( int64_t value, char* buffer, integer idx, int overrideWidth  );
     ...
     **********************************************************************************************/
    inline
    integer  WriteDecUnsigned( uint64_t value, char* buffer, integer idx, int overrideWidth  )
    {
     ...
     **********************************************************************************************/
    ALIB_API
    integer  WriteBin( uint64_t value, char* buffer, integer idx, int overrideWidth  );
     ...
     **********************************************************************************************/
    ALIB_API
    integer  WriteHex( uint64_t value, char* buffer, integer idx, int overrideWidth  );
     ...
     **********************************************************************************************/
    ALIB_API
    integer  WriteOct( uint64_t value, char* buffer, integer idx, int overrideWidth  );
     ...
     **********************************************************************************************/
    ALIB_API
    integer  WriteFloat( double value, char*  buffer, integer idx, int overrideWidth  );
