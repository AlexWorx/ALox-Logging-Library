...
// include guard
#ifndef HPP_ALIB_STRINGS_FORMATTER
#define HPP_ALIB_STRINGS_FORMATTER 1
 ...
 *   \ref aworx::lib::strings::FormatterPythonStyle "FormatterPythonStyle", if a custom format
 ...
 * - \ref aworx::lib::strings::FormatterPythonStyle  "FormatterPythonStyle", which mimics
 *   the [Python formatting syntax](https://docs.python.org/3.5/library/string.html#format-string-syntax)
 *   and
 * - \ref aworx::lib::strings::FormatterJavaStyle    "FormatterJavaStyle", which mimics
 ...
 * With class
 * \ref aworx::lib::strings::FormatterStdImpl "FormatterStdImpl" a - still abstract -
 ...
 * \ref aworx::lib::strings::FormatterPythonStyle  "FormatterPythonStyle" and
 * \ref aworx::lib::strings::FormatterJavaStyle    "FormatterJavaStyle" derive from
...
class Formatter
{
    ...
    // #############################################################################################
        ...
        ALIB_API
        virtual
        void    FormatList( AString& target, const Boxes&  args );
...
using     Formatter=            aworx::lib::strings::Formatter;

}  // namespace aworx

#endif // HPP_ALIB_STRINGS_FORMATTER
