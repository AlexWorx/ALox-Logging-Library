 ...
 */
    ...
    extern void DbgSimpleALibMsg( const char* file, int line, const char* method,
                                  int type,
                                  const char* msg, const int intValue );
     ...
     * - \p func: Information about the scope of invocation.
    ...
    #define ALIB_ERROR(...)                { aworx::lib::debug::DbgSimpleALibMsg( ALIB_SRCPOS_REL_EMPTY, 0, __VA_ARGS__); }
    #define ALIB_WARNING(...)              { aworx::lib::debug::DbgSimpleALibMsg( ALIB_SRCPOS_REL_EMPTY, 1, __VA_ARGS__); }
    #define ALIB_MESSAGE(...)              { aworx::lib::debug::DbgSimpleALibMsg( ALIB_SRCPOS_REL_EMPTY, 2, __VA_ARGS__); }
