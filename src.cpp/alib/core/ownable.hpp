...
#endif
#if defined(HPP_COM_ALIB_TEST_INCLUDES) && defined(HPP_AWORX_LIB_OWNABLE)
...
#ifndef HPP_AWORX_LIB_OWNABLE
#if !defined( IS_DOXYGEN_PARSER)
#define HPP_AWORX_LIB_OWNABLE 1
#endif
