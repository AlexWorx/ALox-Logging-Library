 ...
 * is sufficient and all \b %ALib internal warnings and errors will be directed to this one.
 * Software built on \b %ALib should do the same with internal warnings and errors. An own
 ...
 *  of \b %ALib reports and corresponding macros.
 **************************************************************************************************/
class Report
{
    // #############################################################################################
    ...
    public:
        ...
        class Message : public Boxes
        {
            ...
            Message( const strings::TString& file, int line, const strings::TString& func,
    ...
    public:
        ...
        void DoReport( const strings::TString& file, int line, const strings::TString& func,
                       int type,  Boxes&&... msgs )
        {
