...
class Resources
{
    ...
    protected:
        ...
        /**
         * Two nested \c std::map objects to store static hard-coded default resources.
         ...
         */
        std::map<String, std::map<String, String>>      defaults;

        /**
         * Two nested \c std::map objects to store copies of resources found in #Config.
         ...
         */
        std::map<String, std::map<String, String>>      cachedVariables;
     ...
     ********************************************************************************************~*/
    ALIB_API
    void AddBulk( const char* category, ... );
