 ...
 * \b %ALib built-in mechanism that become available to all enum types that specialize
 ...
 *   with \alib{strings::applyto,T_Apply<TEnumBitwise>}.
 * <p>
 *
 * \note
 ...
 * - \alib{strings,Substring::ConsumeEnum},
 * - \alib{strings,Substring::ConsumeEnumBitwise} and
 * - \alib{strings,Substring::ConsumeEnumOrBool}.
 *
 ...
 *   \alib{strings::applyto,T_Apply<TEnum>} and
 *   \alib{strings::applyto,T_Apply<TEnumBitwise>}, it is always the first entry found in a table
 ...
 *   with methods
 *   \alib{strings,Substring::ConsumeEnum,ConsumeEnum},
 *   \alib{strings,Substring::ConsumeEnumBitwise,ConsumeEnumBitwise} or
 *   \alib{strings,Substring::ConsumeEnumOrBool,ConsumeEnumOrBool}
 ...
 *     \alib{strings,Substring::ConsumeEnum,ConsumeEnum},
 *     \alib{strings,Substring::ConsumeEnumBitwise,ConsumeEnumBitwise} and
 *     \alib{strings,Substring::ConsumeEnumOrBool,ConsumeEnumOrBool}.
 *
 * @tparam TEnum        The enumeration type.
 * @tparam TEnableIf    To be ignored. Used to select this struct only for enum types which have
...
struct T_EnumMetaDataDeclReadWrite   :  public std::false_type
{
     ...
     * \alib{strings,Substring::ConsumeEnum},
     * \alib{strings,Substring::ConsumeEnumBitwise} or
     * \alib{strings,Substring::ConsumeEnumOrBool}
     * (or a custom parsing method).
     */
 ...
 * \alib{strings::applyto,T_Apply<TEnum>} and
 * \alib{strings::applyto,T_Apply<TEnumBitwise>} (or custom code) to retrieve and write
 ...
 * \alib{strings::applyto,T_Apply<TEnum>} and
 * \alib{strings::applyto,T_Apply<TEnumBitwise>}.<br>
...
struct EnumReadWriteInfo
{
     ...
     * \alib{strings::applyto,T_Apply<TEnum>} and \alib{strings::applyto,T_Apply<TEnumBitwise>}
 ...
 *   \alib{strings::applyto,T_Apply<TEnum>} and
 *   \alib{strings::applyto,T_Apply<TEnumBitwise>} and this way allow to "apply" enum elements
 *   to instances of class \alib{strings,AString}.
 *
 *   @param TEnum             The enumeration type to define meta data for.
 *
 *
 ...
 *   \alib{strings::applyto,T_Apply<TEnum>} and
 *   \alib{strings::applyto,T_Apply<TEnumBitwise>}, which write enum element names into
 *   objects of type \alib{strings,AString}.
 *
...
template<> struct aworx::lib::lang::T_EnumMetaDataDeclReadWrite<TEnum>  :  public std::true_type   \
{                                                                                                  \
...
template<> struct aworx::lib::lang::T_EnumMetaDataPreAndPostFix<TEnum>  :  public std::true_type   \
{                                                                                                  \
...
template<> struct aworx::lib::lang::T_EnumMetaDataDecl<TEnum>  :  public std::true_type            \
{                                                                                                  \
 ...
 * \ref aworx::lib::strings::applyto::T_Apply<TEnumBitwise> "specialization of T_Apply" is
 * provided.)<br>
 * The conditions are evaluated by the compiler using \c std::enable_if on optional template
 * parameter \p TEnableIf of \ref aworx::lib::strings::T_Apply "T_Apply".
 *
 ...
 */
template<typename TEnum>
struct  T_Apply<TEnum>
#else
template<typename TEnum>
struct  T_Apply<TEnum, typename std::enable_if<(     T_EnumMetaDataDeclReadWrite<TEnum>::NameIndex
                                                 !=  0 )
 ...
 * \ref aworx::lib::strings::T_Apply "T_Apply" for enum types which meet the following conditions:
 * - A specialization of TMP struct \alib{lang,T_EnumMetaDataDeclReadWrite} exists whose member
 *   \alib{lang,T_EnumMetaDataDeclReadWrite::NameIndex,NameIndex} does not evalute to \c 0.
 ...
 *  \ref aworx::lib::strings::applyto::T_Apply<TEnum> "specialization of T_Apply" is
 * provided.)<br>
 * The conditions are evaluated by the compiler using \c std::enable_if on optional template
 * parameter \p TEnableIf of \ref aworx::lib::strings::T_Apply "T_Apply".
 *
...
ALIB_LANG_RESOURCED ( aworx::lib::lang::Case, LANG, "Case" )
//! [DOX_ALIB_LANG_ENUMS_PARSABLE_2]
...
ALIB_LANG_RESOURCED( aworx::lib::lang::Bool          , LANG, "Bool"          )
ALIB_LANG_RESOURCED( aworx::lib::lang::Switch        , LANG, "Switch"        )
ALIB_LANG_RESOURCED( aworx::lib::lang::Alignment     , LANG, "Alignment"     )
ALIB_LANG_RESOURCED( aworx::lib::lang::SortOrder     , LANG, "SortOrder"     )
ALIB_LANG_RESOURCED( aworx::lib::lang::Inclusion     , LANG, "Inclusion"     )
ALIB_LANG_RESOURCED( aworx::lib::lang::Reach         , LANG, "Reach"         )
ALIB_LANG_RESOURCED( aworx::lib::lang::CurrentData   , LANG, "CurrentData"   )
ALIB_LANG_RESOURCED( aworx::lib::lang::SourceData    , LANG, "SourceData"    )
ALIB_LANG_RESOURCED( aworx::lib::lang::Safeness      , LANG, "Safeness"      )
ALIB_LANG_RESOURCED( aworx::lib::lang::Responsibility, LANG, "Responsibility")
ALIB_LANG_RESOURCED( aworx::lib::lang::Timezone      , LANG, "Timezone"      )
ALIB_LANG_RESOURCED( aworx::lib::lang::LockMode      , LANG, "LockMode"      )
ALIB_LANG_RESOURCED( aworx::lib::lang::Whitespaces   , LANG, "Whitespaces"   )
ALIB_LANG_RESOURCED( aworx::lib::lang::Create        , LANG, "Create"        )
ALIB_LANG_RESOURCED( aworx::lib::lang::Propagation   , LANG, "Propagation"   )
ALIB_LANG_RESOURCED( aworx::lib::lang::Phase         , LANG, "Phase"         )
ALIB_LANG_RESOURCED( aworx::lib::lang::ContainerOp   , LANG, "ContainerOp"   )
