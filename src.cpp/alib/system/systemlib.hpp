...
#endif
#if defined(HPP_COM_ALIB_TEST_INCLUDES) && defined(HPP_ALIB_SYSTEM_SYSTEM_LIB)
    #error "Header already included"
#endif

// then, set include guard
#ifndef HPP_ALIB_SYSTEM_SYSTEM_LIB
//! @cond NO_DOX
#define HPP_ALIB_SYSTEM_SYSTEM_LIB 1
//! @endcond
...
/** ************************************************************************************************
 * The library class for namespace \ref aworx::lib::system.
 **************************************************************************************************/
class System  : public lang::Library
{
    // #############################################################################################
    // internals
    // #############################################################################################
    ...
    public:
        inline  System()
                : lang::Library( ALIB_VERSION, ALIB_REVISION, "ALIB_SYSTEM" )
        {}
    ...
    protected:
        /** ****************************************************************************************
         * Initializes the \alib \ref aworx::lib::system.
         *
...
/** ************************************************************************************************
 * The static library singleton of namespace #aworx::lib::system.
 **************************************************************************************************/
ALIB_API
extern system::System SYSTEM;
} // namespace aworx[::lib]
...
namespace lib { namespace system {


/** ************************************************************************************************
 * Denotes exceptions thrown by classes of namespace \ref aworx::lib::system.
 **************************************************************************************************/
...
ALIB_LANG_EXCEPTIONS( aworx::lib::system::Exceptions  , SYSTEM, "Exceptions"   )
ALIB_LANG_EXCEPTIONS( aworx::lib::system::SystemErrors, SYSTEM, "SystemErrors" )


#endif // HPP_ALIB_SYSTEM_SYSTEM_LIB
