...
class Config  : public lang::Library
{
    ...
    public:
        inline  Config()
        : lang::Library( ALIB_VERSION, ALIB_REVISION, "ALIB_CONFIG" )
        {}
...
ALIB_ENUM_SPECIFICATION_DECL( aworx::lib::config::VariableDecl,
                              String, String, String, char, String, int, String )
namespace aworx { namespace lib { namespace config {
...
struct VariableDecl
{
     ...
     */
    char        Delim()                                   const     {  return std::get<4>( Tuple ); }
...
ALIB_LANG_EXCEPTIONS(  aworx::lib::config::Exceptions, lib::CONFIG, "Exceptions" )
