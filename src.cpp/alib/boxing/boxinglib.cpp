...
selected \b %ALib distribution.

\note
  As explained \ref aworx::lib "here", currently the full \b %ALib distribution is bundled together
  with the <b>%ALox Logging Library</b>, hence as a replacement, singleton
  \ref aworx::lox::ALOX might be used.
...
#endif
{
...
#endif
    {
        ...
        DefineDefaultInterface<IIsTrue >();
            ...
            DefineInterface<char           , true , ftypes::IEquals_TcharArr    >();
            DefineInterface<wchar_t        , true , ftypes::IEquals_Twchar_tArr >();
            DefineInterface<char16_t       , true , ftypes::IEquals_Tchar16_tArr>();
            DefineInterface<char32_t       , true , ftypes::IEquals_Tchar32_tArr>();
...
void  Boxing::dbgCheckNewBoxer( Boxer* boxer )
{
    ...
    {
        ALIB_ERROR( "Double instantiation of Boxer of Type: \"", debug::TypeDemangler( boxer->type ).Get(), "\"" )
        return;
    }
