...
namespace qt {
     ...
     **********************************************************************************************/
     template<>   struct  T_String<QLatin1String>  : public std::true_type
     {
        /** ****************************************************************************************
     ...
     **********************************************************************************************/
    template<>   struct  T_String<QByteArray>  : public std::true_type
    {
        /** ****************************************************************************************
         * Returns the  result of \b src.data.
         *
    ...
    template<> struct T_Apply<QChar>   : public std::true_type
    {
        /** ****************************************************************************************
         ...
         ******************************************************************************************/
        static inline integer Apply( AString& target, const QChar& src )
        {
    ...
    template<> struct T_Apply<QByteArray>   : public std::true_type
    {
        /** ****************************************************************************************
         ...
         * @return The length of the given string \p src which was appended to \p target.
         ******************************************************************************************/
        static inline integer Apply( AString& target, const QByteArray& src )
        {
            int len= src.length();
    ...
    template<> struct T_Apply<QVector<uint>>   : public std::true_type
    {
        /** ****************************************************************************************
         ...
         * @return The length of the given string \p src which was appended to \p target.
         ******************************************************************************************/
        static inline integer Apply( AString& target, const QVector<uint>& src )
        {
    ...
    template<> struct T_Apply<QString>   : public std::true_type
    {
        /** ****************************************************************************************
         ...
         * @return The length of the given string \p src which was appended to \p target.
         ******************************************************************************************/
        static inline integer Apply( AString& target, const QString& src )
        {
            int len= src.length();
     ...
     **********************************************************************************************/
    inline
    QString  ToQString( const String& as, integer regionStart, integer regionLength= CString::MaxLen )
    {
        QString result;
...
{
    #if ALIB_MODULE_STRINGS
        aworx::lib::boxing::DefineInterface<BoxedAs<QByteArray>    , false , strings::boxing::IApply_BoxedAs_TApplicable<QByteArray>   >();
        aworx::lib::boxing::DefineInterface<BoxedAs<QLatin1String> , false , strings::boxing::IApply_BoxedAs_TApplicable<QLatin1String>>();
        aworx::lib::boxing::DefineInterface<BoxedAs<QString>       , false , strings::boxing::IApply_BoxedAs_TApplicable<QString>      >();
    #endif
}
