...
/** ************************************************************************************************
 * Implementation of
 * \ref aworx::lib::util::StringTreeDefaultKeyAllocator "StringTreeDefaultKeyAllocator"
 ...
 * \ref aworx::lib::util::StringTreeDefaultKeyAllocator "StringTreeDefaultKeyAllocator", which
...
class StringTree
{
    ...
    protected:
        ...
        using TMap=    UnorderedStringMap<Node*>;
    ...
    public:
        ...
        class Cursor
        {
            ...
            protected:
                 ...
                 */
                static
                Node* createPathAndReturnLeafx( Node* node, Substring& path )
                {
                    bool isFirst= true;
                    for(;;)
                    {
            ...
            //####  Tree navigation inplace, returning status      #################################
                 ...
                 *    \snippet "src.cpp/alib/util/stringtree.hpp"     DOX_ALIB_STRING_TREE_MOVETOPARENT
                ...
                bool    MoveToAndCreateNonExistingPart( const String& path )
                {
                    ...
                    for(;;)
                    {
                        ...
                        if( rest.IsEmpty() )
                            break;
                        created= true;
                        node= createPathAndReturnLeafx( node, rest );
                    }
                    return created;
            }
...
template<typename T, typename TKeyAllocator= aworx::lib::util::StringTreeDefaultKeyAllocator<T>>
using  StringTree=    aworx::lib::util::StringTree<T, TKeyAllocator>;
