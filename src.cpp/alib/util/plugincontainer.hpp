    ...
    public:
                                                           ...
                                                           = lang::Responsibility::KeepWithSender )
        {
            ...
            ALIB_ASSERT_ERROR(    std::has_virtual_destructor<TPlugin>::value
                               ...
                               "Can't take responsibility for plug-in destruction. TPlugin has no "
                               "virtual destructor."                           )
        ...
        bool                RemovePlugin( TPlugin* plugin )
        {
            ...
            ALIB_ASSERT_WARNING( plugins.size() != qty, "PluginContainer::RemovePlugin(): No Plug-in was removed " )
        ...
        TPlugin*            RemovePlugin( TPriorities priority )
        {
            ...
            ALIB_ASSERT_WARNING( plugin, "PluginContainer::RemovePlugin(): No Plug-in was removed " )
