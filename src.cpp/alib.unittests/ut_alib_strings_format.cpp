...
ut.EQ( __FILE__, __LINE__,  0,  as.ParseInt()   );
    ...
    // parse integers
    {
        as._()._( "123456789");      UT_EQ( 123456789L,  as.ParseInt  ( 0_integer, &pos ) );        UT_EQ(  0 + as.Length() , pos );
        as._()._( "  123");          UT_EQ( 123L,        as.ParseInt  ( 0_integer, &pos ) );        UT_EQ(  0 + as.Length() , pos );
        as._()._( "  -23  ");        UT_EQ( -23L,        as.ParseInt  ( 0_integer, &pos ) );        UT_EQ( -2 + as.Length() , pos );
        as._()._(   "123  ");        UT_EQ( 123L,        as.ParseInt  ( 0_integer, &pos ) );        UT_EQ( -2 + as.Length() , pos );

        as._()._( "xxx123456789");   UT_EQ( 123456789L,  as.ParseInt  ( 3, &pos ) );        UT_EQ(  0 + as.Length() , pos );
        as._()._( "xxx  123");       UT_EQ( 123L,        as.ParseInt  ( 3, &pos ) );        UT_EQ(  0 + as.Length() , pos );
        as._()._( "xxx  123  ");     UT_EQ( 123L,        as.ParseInt  ( 3, &pos ) );        UT_EQ( -2 + as.Length() , pos );
        as._()._(   "xxx123  ");     UT_EQ( 123L,        as.ParseInt  ( 3, &pos ) );        UT_EQ( -2 + as.Length() , pos );
    }
    ...
    // parse with grouping symbol
    {
        ...
        as._()._( "123,456,789");   UT_EQ( 123456789L,  as.ParseInt( 0, &numberFormat, &pos ) ); UT_EQ(  0 + as.Length() , pos );
        as._()._( "  1,2,3"    );   UT_EQ( 123L,        as.ParseInt( 0, &numberFormat, &pos ) ); UT_EQ(  0 + as.Length() , pos );
        as._()._( " +1,2,,4"   );   UT_EQ( 124L,        as.ParseInt( 0, &numberFormat, &pos ) ); UT_EQ(  0 + as.Length() , pos );
        as._()._( "  -2,3  "   );   UT_EQ( -23L,        as.ParseInt( 0, &numberFormat, &pos ) ); UT_EQ( -2 + as.Length() , pos );
        as._()._(   ",123  "   );   UT_EQ(   0L,        as.ParseInt( 0, &numberFormat, &pos ) ); UT_EQ(  0               , pos );
    }
    ...
    // int32
    {
        ...
        ms._(); ui= 0;       ms._( ui    );                UT_EQ(      "0", ms );
        ms._(); ui= 0;       ms._( Format( ui, 1 ,nf) );   UT_EQ(      "0", ms );
        ms._(); ui= 0;       ms._( Format( ui, 3 ,nf) );   UT_EQ(    "000", ms );
        ms._(); ui= 10;      ms._( ui    );                UT_EQ(     "10", ms );
        ms._(); ui= 100;     ms._( Format( ui, 1 ,nf) );   UT_EQ(    "100", ms );
        ms._(); ui= 100;     ms._( Format( ui, 3 ,nf) );   UT_EQ(    "100", ms );
        ms._(); ui= 100;     ms._( Format( ui, 4 ,nf) );   UT_EQ(   "0100", ms );
        ms._(); ui= 23;      ms._( ui    );                UT_EQ(     "23", ms );
        ms._(); ui= 99;      ms._( Format( ui, 5 ,nf) );   UT_EQ(  "00099", ms );
        ms._();  i= 49;      ms._( i     );                UT_EQ(     "49", ms );
        ms._();  i= -5;      ms._( Format ( i, 5 ,nf) );   UT_EQ(  "-0005", ms );
        ms._();  i= -5324;   ms._( Format ( i, 2 ,nf) );   UT_EQ(  "-5324", ms );
        ms._(); ui= std::numeric_limits<uint32_t>::max();    ms._(         ui            );   UT_EQ(    "4294967295",  ms );
        ms._(); ui= std::numeric_limits<uint32_t>::min();    ms._(         ui            );   UT_EQ(             "0",  ms );
        ms._();  i= std::numeric_limits<int32_t> ::max();    ms._(         i             );   UT_EQ(    "2147483647",  ms );
        ms._();  i= std::numeric_limits<int32_t> ::min();    ms._(         i             );   UT_EQ(   "-2147483648",  ms );

        ms._(); ui= std::numeric_limits<uint32_t>::max();    ms._( Format( ui ,&nfG    ) );   UT_EQ( "4,294,967,295",  ms );
        ms._(); ui= std::numeric_limits<uint32_t>::min();    ms._( Format( ui ,&nfG    ) );   UT_EQ(             "0",  ms );
        ms._();  i= std::numeric_limits<int32_t> ::max();    ms._( Format ( i ,&nfG    ) );   UT_EQ( "2,147,483,647",  ms );
        ms._();  i= std::numeric_limits<int32_t> ::min();    ms._( Format ( i ,&nfG    ) );   UT_EQ("-2,147,483,648",  ms );

        ms._(); ui= std::numeric_limits<uint32_t>::max();    ms._( Format( ui , 12 ,nf ) );   UT_EQ(  "004294967295",  ms );
        ms._(); ui= std::numeric_limits<uint32_t>::min();    ms._( Format( ui , 12 ,nf ) );   UT_EQ(  "000000000000",  ms );
        ms._();  i= std::numeric_limits<int32_t> ::max();    ms._( Format ( i , 12 ,nf ) );   UT_EQ(  "002147483647",  ms );
        ms._();  i= std::numeric_limits<int32_t> ::min();    ms._( Format ( i , 12 ,nf ) );   UT_EQ(  "-02147483648",  ms );
    }
    ...
    // int64
    {
        ...
        ui= 0;       ms._()._( Format( ui, 1  ,nf ));  UT_EQ(      "0", ms );
        ui= 0;       ms._()._( Format( ui, 3  ,nf ));  UT_EQ(    "000", ms );
        ui= 10;      ms._()._( ui );                   UT_EQ(     "10", ms );
        ui= 100;     ms._()._( Format( ui, 1  ,nf ));  UT_EQ(    "100", ms );
        ui= 100;     ms._()._( Format( ui, 3  ,nf ));  UT_EQ(    "100", ms );
        ui= 100;     ms._()._( Format( ui, 4  ,nf ));  UT_EQ(   "0100", ms );
        ui= 23;      ms._()._( ui );                   UT_EQ(     "23", ms );
        ui= 99;      ms._()._( Format( ui, 5  ,nf ));  UT_EQ(  "00099", ms );
         i= 49;      ms._()._(                 i   );  UT_EQ(     "49", ms );
         i= -5;      ms._()._( Format ( i, 5  ,nf ));  UT_EQ(  "-0005", ms );
         i= -5324;   ms._()._( Format ( i, 2  ,nf ));  UT_EQ(  "-5324", ms );
        ui= std::numeric_limits<uint32_t>::max();    ms._()._(                ui     );  UT_EQ(    "4294967295",  ms );
        ui= std::numeric_limits<uint32_t>::min();    ms._()._(                ui     );  UT_EQ(             "0",  ms );
         i= std::numeric_limits<int32_t> ::max();    ms._()._(                i      );  UT_EQ(    "2147483647",  ms );
         i= std::numeric_limits<int32_t> ::min();    ms._()._(                i      );  UT_EQ(   "-2147483648",  ms );

        ui= std::numeric_limits<uint32_t>::max();    ms._()._( Format(   ui ,&nfG   ));  UT_EQ( "4,294,967,295",  ms );
        ui= std::numeric_limits<uint32_t>::min();    ms._()._( Format(   ui ,&nfG   ));  UT_EQ(             "0",  ms );
         i= std::numeric_limits<int32_t> ::max();    ms._()._( Format(   i  ,&nfG   ));  UT_EQ( "2,147,483,647",  ms );
         i= std::numeric_limits<int32_t> ::min();    ms._()._( Format(   i  ,&nfG   ));  UT_EQ("-2,147,483,648",  ms );

        ui= std::numeric_limits<uint32_t>::max();    ms._()._( Format(ui, 12,nf));  UT_EQ(  "004294967295",  ms );
        ui= std::numeric_limits<uint32_t>::min();    ms._()._( Format(ui, 12,nf));  UT_EQ(  "000000000000",  ms );
         i= std::numeric_limits<int32_t> ::max();    ms._()._( Format(i , 12,nf));  UT_EQ(  "002147483647",  ms );
         i= std::numeric_limits<int32_t> ::min();    ms._()._( Format(i , 12,nf));  UT_EQ(  "-02147483648",  ms );

        ui= std::numeric_limits<uint64_t>::max();    ms._()._( Format(  ui,&nfG     ));  UT_EQ( "18,446,744,073,709,551,615",  ms );
        ui= std::numeric_limits<uint64_t>::min();    ms._()._( Format(  ui,&nfG     ));  UT_EQ(                          "0",  ms );
         i= std::numeric_limits<int64_t> ::max();    ms._()._( Format(  i ,&nfG     ));  UT_EQ(  "9,223,372,036,854,775,807",  ms );
        ms.SetBuffer(20);
         i= std::numeric_limits<int64_t> ::min();    ms._()._( Format(  i ,&nfG     ));  UT_EQ( "-9,223,372,036,854,775,808",  ms );
         i= std::numeric_limits<int64_t> ::min() + 75008; ms._()._(Format(i,&nfG    ));  UT_EQ( "-9,223,372,036,854,700,800",  ms );
    }
    ...
    // plus sign
    {
        ...
        i= 49;                            ms._()._( i );                  UT_EQ(     "49", ms );
        i= 49;      nf.PlusSign=' '; ms._()._( Format ( i, -1, &nf  ) );  UT_EQ(    " 49", ms );
        i= 49;      nf.PlusSign='+'; ms._()._( Format ( i, -1, &nf  ) );  UT_EQ(    "+49", ms );
        i= 49;      nf.PlusSign=' '; ms._()._( Format ( i,  5, &nf  ) );  UT_EQ(  "  049", ms );
        i= 49;      nf.PlusSign='+'; ms._()._( Format ( i,  5, &nf  ) );  UT_EQ(  "+ 049", ms );
    }
    ...
    // Group character
    {
        ...
        w=  3; ms._(); ui=              100;      ms._( Format( ui , w, &nf  ) );   UT_EQ(                "100",  ms ); UT_EQ( w, ms.Length() );
        w=  4; ms._(); ui=              100;      ms._( Format( ui , w, &nf  ) );   UT_EQ(               " 100",  ms ); UT_EQ( w, ms.Length() );
        w=  5; ms._(); ui=              100;      ms._( Format( ui , w, &nf  ) );   UT_EQ(              "0,100",  ms ); UT_EQ( w, ms.Length() );
        w=  7; ms._(); ui=           100000;      ms._( Format( ui , w, &nf  ) );   UT_EQ(            "100,000",  ms ); UT_EQ( w, ms.Length() );
        w=  8; ms._(); ui=           100000;      ms._( Format( ui , w, &nf  ) );   UT_EQ(           " 100,000",  ms ); UT_EQ( w, ms.Length() );
        w=  9; ms._(); ui=           100000;      ms._( Format( ui , w, &nf  ) );   UT_EQ(          "0,100,000",  ms ); UT_EQ( w, ms.Length() );
        w= 11; ms._(); ui=        100000000;      ms._( Format( ui , w, &nf  ) );   UT_EQ(        "100,000,000",  ms ); UT_EQ( w, ms.Length() );
        w= 12; ms._(); ui=        100000000;      ms._( Format( ui , w, &nf  ) );   UT_EQ(       " 100,000,000",  ms ); UT_EQ( w, ms.Length() );
        w= 13; ms._(); ui=        100000000;      ms._( Format( ui , w, &nf  ) );   UT_EQ(      "0,100,000,000",  ms ); UT_EQ( w, ms.Length() );
        w= 15; ms._(); ui=     100000000000;      ms._( Format( ui , w, &nf  ) );   UT_EQ(    "100,000,000,000",  ms ); UT_EQ( w, ms.Length() );
        w= 16; ms._(); ui=     100000000000;      ms._( Format( ui , w, &nf  ) );   UT_EQ(   " 100,000,000,000",  ms ); UT_EQ( w, ms.Length() );
        w= 17; ms._(); ui=     100000000000;      ms._( Format( ui , w, &nf  ) );   UT_EQ(  "0,100,000,000,000",  ms ); UT_EQ( w, ms.Length() );

        w=  3; ms._(); i=     -         100;      ms._( Format(  i , w, &nf  ) );   UT_EQ(               "-100",  ms ); UT_EQ( w+1, ms.Length() );
        w=  4; ms._(); i=     -         100;      ms._( Format(  i , w, &nf  ) );   UT_EQ(               "-100",  ms ); UT_EQ( w  , ms.Length() );
        w=  5; ms._(); i=     -         100;      ms._( Format(  i , w, &nf  ) );   UT_EQ(              "- 100",  ms ); UT_EQ( w  , ms.Length() );
        w=  6; ms._(); i=     -         100;      ms._( Format(  i , w, &nf  ) );   UT_EQ(             "-0,100",  ms ); UT_EQ( w  , ms.Length() );
        w=  7; ms._(); i=     -      100000;      ms._( Format(  i , w, &nf  ) );   UT_EQ(           "-100,000",  ms ); UT_EQ( w+1, ms.Length() );
        w=  8; ms._(); i=     -      100000;      ms._( Format(  i , w, &nf  ) );   UT_EQ(           "-100,000",  ms ); UT_EQ( w  , ms.Length() );
        w=  9; ms._(); i=     -      100000;      ms._( Format(  i , w, &nf  ) );   UT_EQ(          "- 100,000",  ms ); UT_EQ( w  , ms.Length() );
        w= 10; ms._(); i=     -      100000;      ms._( Format(  i , w, &nf  ) );   UT_EQ(         "-0,100,000",  ms ); UT_EQ( w  , ms.Length() );
        w= 11; ms._(); i=     -   100000000;      ms._( Format(  i , w, &nf  ) );   UT_EQ(       "-100,000,000",  ms ); UT_EQ( w+1, ms.Length() );
        w= 12; ms._(); i=     -   100000000;      ms._( Format(  i , w, &nf  ) );   UT_EQ(       "-100,000,000",  ms ); UT_EQ( w  , ms.Length() );
        w= 13; ms._(); i=     -   100000000;      ms._( Format(  i , w, &nf  ) );   UT_EQ(      "- 100,000,000",  ms ); UT_EQ( w  , ms.Length() );
        w= 14; ms._(); i=     -   100000000;      ms._( Format(  i , w, &nf  ) );   UT_EQ(     "-0,100,000,000",  ms ); UT_EQ( w  , ms.Length() );
        w= 15; ms._(); i=     -100000000000;      ms._( Format(  i , w, &nf  ) );   UT_EQ(   "-100,000,000,000",  ms ); UT_EQ( w+1, ms.Length() );
        w= 16; ms._(); i=     -100000000000;      ms._( Format(  i , w, &nf  ) );   UT_EQ(   "-100,000,000,000",  ms ); UT_EQ( w  , ms.Length() );
        w= 17; ms._(); i=     -100000000000;      ms._( Format(  i , w, &nf  ) );   UT_EQ(  "- 100,000,000,000",  ms ); UT_EQ( w  , ms.Length() );
        w= 18; ms._(); i=     -100000000000;      ms._( Format(  i , w, &nf  ) );   UT_EQ( "-0,100,000,000,000",  ms ); UT_EQ( w  , ms.Length() );
    }
}
...
void intTestRoundtrip( AWorxUnitTesting& ut, int64_t i )
{
    ...
    itAS._()._("  ")._( Format( i, &itNF ) );  if( i>=0) {uiBack= itAS.ParseDec  ( 2,     &itNF  );   UT_EQ( i, static_cast<int64_t>(uiBack )); }
                                                           iBack= itAS.ParseInt  (        &itNF  );   UT_EQ( i, iBack );
                                      itSB.Set(itAS);     UT_TRUE(itSB.ConsumeInt( iBack, &itNF ));   UT_EQ( i, iBack ); UT_TRUE(itSB.IsEmpty())


    if( i >= 0 )
    {
        itAS._()._("0b")._( Format::Bin  (ui, &itNF ) );  uiBack= itAS.ParseBin  ( 2,     &itNF  );   UT_EQ( i, static_cast<int64_t>(uiBack ));
                                                           iBack= itAS.ParseInt  (        &itNF  );   UT_EQ( i, iBack );
                                      itSB.Set(itAS, 2);  UT_TRUE(itSB.ConsumeBin(uiBack, &itNF ));   UT_EQ( i, static_cast<int64_t>( uiBack ) ); UT_TRUE(itSB.IsEmpty())
                                      itSB.Set(itAS);     UT_TRUE(itSB.ConsumeInt( iBack, &itNF ));   UT_EQ( i,                        iBack   ); UT_TRUE(itSB.IsEmpty())

        itAS._()._("0x")._( Format::Hex  (ui, &itNF ) );  uiBack= itAS.ParseHex  ( 2,     &itNF  );   UT_EQ( i, static_cast<int64_t>(uiBack ));
                                                           iBack= itAS.ParseInt  (        &itNF  );   UT_EQ( i, iBack );
                                      itSB.Set(itAS, 2);  UT_TRUE(itSB.ConsumeHex(uiBack, &itNF ));   UT_EQ( i, static_cast<int64_t>( uiBack ) ); UT_TRUE(itSB.IsEmpty())
                                      itSB.Set(itAS);     UT_TRUE(itSB.ConsumeInt( iBack, &itNF ));   UT_EQ( i,                        iBack   ); UT_TRUE(itSB.IsEmpty())

        itAS._()._("0o")._( Format::Oct  (ui, &itNF ) );  uiBack= itAS.ParseOct  ( 2,     &itNF  );   UT_EQ( i, static_cast<int64_t>(uiBack ));
                                                           iBack= itAS.ParseInt  (        &itNF  );   UT_EQ( i, iBack );
                                      itSB.Set(itAS, 2);  UT_TRUE(itSB.ConsumeOct(uiBack, &itNF ));   UT_EQ( i, static_cast<int64_t>( uiBack ) ); UT_TRUE(itSB.IsEmpty())
                                      itSB.Set(itAS);     UT_TRUE(itSB.ConsumeInt( iBack, &itNF ));   UT_EQ( i,                        iBack   ); UT_TRUE(itSB.IsEmpty())
    }
}
...
void intTestRoundtripUS( AWorxUnitTesting& ut, uint64_t ui )
{
    ...
    itAS._()._("0b")._( Format::Bin  ( ui, &itNF ) );  uiBack= itAS.ParseBin ( 2,     &itNF  );  UT_EQ( ui, uiBack );
                                                        iBack= itAS.ParseInt (        &itNF  );  UT_EQ( ui, static_cast<uint64_t>(iBack ));
                                  itSB.Set(itAS, 2);  UT_TRUE(itSB.ConsumeBin( uiBack,&itNF ));  UT_EQ( ui, uiBack ); UT_TRUE(itSB.IsEmpty())

    itAS._()._("0x")._( Format::Hex  ( ui, &itNF ) );  uiBack= itAS.ParseHex ( 2,     &itNF  );  UT_EQ( ui, uiBack );
                                                       iBack= itAS.ParseInt  (        &itNF  );  UT_EQ( ui, static_cast<uint64_t>(iBack ));
                                  itSB.Set(itAS, 2);  UT_TRUE(itSB.ConsumeHex( uiBack,&itNF ));  UT_EQ( ui, uiBack ); UT_TRUE(itSB.IsEmpty())

    itAS._()._("0o")._( Format::Oct  ( ui, &itNF ) );  uiBack= itAS.ParseOct ( 2,     &itNF );   UT_EQ( ui, uiBack );
                                                       iBack= itAS.ParseInt  (        &itNF );   UT_EQ( ui, static_cast<uint64_t>(iBack ));
                                  itSB.Set(itAS, 2);  UT_TRUE(itSB.ConsumeOct( uiBack,&itNF ));  UT_EQ( ui, uiBack ); UT_TRUE(itSB.IsEmpty())
}
...
UT_METHOD( ConvertIntegers )
{
    ...
    // int detection and string borders
    {
        ...
        }
        {
            ...
            Substring substring("0x1234", 0, 2);
            UT_TRUE( substring.ConsumeInt( result ));
            UT_EQ( 0, result );
            UT_EQ( "x", substring );

            AString astring("0x1234"); astring.SetLength(2);
            UT_EQ( 0L,  astring.ParseInt( &newIdx ));
            UT_EQ( 1,  newIdx );
        }
        ...
        }
        {
            ...
            Substring substring("  0x1234", 0, 4);
            UT_TRUE( substring.ConsumeInt( result ));
            UT_EQ( 0, result );
            UT_EQ( "x", substring );

            AString astring("  0x1234"); astring.SetLength(4);
            UT_EQ( 0L,  astring.ParseInt( &newIdx ));
            UT_EQ( 3,  newIdx );
        }
    }
    ...
    intTestDetection( ut, " - 0xF"                  , -15          , true  , -1);
    intTestDetection( ut, " - 0b1"                  ,  -1          , true  , -1);
    intTestDetection( ut, " 0x F12A"                ,   0          , true  ,  2);
    intTestDetection( ut, " 0zF12A"                 ,   0          , true  ,  2);
    intTestDetection( ut, " - 0xF"                  , -0xF         , true  , -1);
    intTestDetection( ut, " - 0b1"                  ,  -1          , true  , -1);
    intTestDetection( ut, " - 0b111"                ,  -7          , true  , -1);
    intTestDetection( ut, " 0b111F"                 ,   7          , true  ,  6);
    intTestDetection( ut, "0o77"                    ,  63          , true  , -1);
    intTestDetection( ut, " \t 0o777"               ,  511         , true  , -1);
    intTestDetection( ut, " \t0o777"                ,  511         , true  , -1);
    intTestDetection( ut, " \t-0o777"               , -511         , true  , -1);
    intTestDetection( ut, " -\t0o777"               , -511         , true  , -1);
    intTestDetection( ut, " -FF"                    ,  0           , false ,  0);
...
UT_METHOD( ConvertFloats )
{
    ...
    // parse NaN and INF
    {
        ...
        as._()._("-inf");    UT_TRUE( isinf( as.ParseFloat( &pos ) ) );                                     UT_EQ( 4, pos );
            ...
            as._()._( "INf");    UT_TRUE( as.ParseFloat( &pos ) ==  std::numeric_limits<double>::infinity() );  UT_EQ( 3, pos );
            as._()._("-INf");    UT_TRUE( as.ParseFloat( &pos ) == -std::numeric_limits<double>::infinity() );  UT_EQ( 4, pos );
    ...
    // write NaN and INF
    {
        as._()._(  std::numeric_limits<double>::quiet_NaN() );    UT_EQ( NumberFormat::Global.NANLiteral,  as );
        as._()._(  std::numeric_limits<double>::infinity()  );    UT_EQ( NumberFormat::Global.INFLiteral,  as );
        as._()._( -std::numeric_limits<double>::infinity()  );    UT_EQ( String16("-")._(NumberFormat::Global.INFLiteral), as );
    }

    // write and parse doubles
    {
        NumberFormat nf;
        nf.DecimalPointChar= '.';  as._()._( "12345.789");      UT_EQ( 12345.789,  as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  0 + as.Length() , pos );
        nf.DecimalPointChar= '@';  as._()._( "12345@789");      UT_EQ( 12345.789,  as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  0 + as.Length() , pos );
        nf.DecimalPointChar= '.';  as._()._( "12345@789");      UT_EQ( 12345.0  ,  as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  5               , pos );

        nf.DecimalPointChar= '.';
        as._()._( "");               UT_EQ(   0.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  0               , pos );
        as._()._(  '-');             UT_EQ(   0.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  0               , pos );
        as._()._( "-X");             UT_EQ(   0.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  0               , pos );
        as._()._(  '.');             UT_EQ(   0.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  1               , pos );
        as._()._( ".0");             UT_EQ(   0.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  2               , pos );
        as._()._( "0.");             UT_EQ(   0.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  2               , pos );
        as._()._( "+.");             UT_EQ(   0.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  2               , pos );
        as._()._( "-.");             UT_EQ(   0.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  2               , pos );
        as._()._( "-.0");            UT_EQ(   0.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  3               , pos );
        as._()._( "-.08");           UT_EQ(  -0.08,           as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  4               , pos );
        as._()._( "  123");          UT_EQ( 123.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  0 + as.Length() , pos );
        as._()._( "+42");            UT_EQ(  42.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  3               , pos );
        as._()._( "  +42  ");        UT_EQ(  42.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ( -2 + as.Length() , pos );
        as._()._( "  +42.  ");       UT_EQ(  42.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ( -2 + as.Length() , pos );
        as._()._( "-23");            UT_EQ( -23.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ(  3               , pos );
        as._()._( "  -23  ");        UT_EQ( -23.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ( -2 + as.Length() , pos );
        as._()._(   "123  ");        UT_EQ( 123.,             as.ParseFloat( 0, &nf, &pos ) );   UT_EQ( -2 + as.Length() , pos );

        as._()._( "xxx123456789");   UT_EQ( 123456789.,       as.ParseFloat( 3, &nf, &pos ) );   UT_EQ(  0 + as.Length() , pos );
        as._()._( "xxx  1.3");       UT_EQ( 1.3,              as.ParseFloat( 3, &nf, &pos ) );   UT_EQ(  0 + as.Length() , pos );
        as._()._( "xxx  1.3  ");     UT_EQ( 1.3,              as.ParseFloat( 3, &nf, &pos ) );   UT_EQ( -2 + as.Length() , pos );
        as._()._(   "xxx1.3  ");     UT_EQ( 1.3,              as.ParseFloat( 3, &nf, &pos ) );   UT_EQ( -2 + as.Length() , pos );

        as._()._( "1.234E1");        UT_EQ( 12.34,            as.ParseFloat( 0, &nf, &pos  ) );  UT_EQ(  0 + as.Length() , pos );
...
template <typename... BoxedObjects>
void    checkFormat(AWorxUnitTesting& ut,  const String& exp, BoxedObjects&&... args )
{
    // create argument objects using implicit constructor invocation
    Boxes boxes( std::forward<BoxedObjects>(args) ... );
...
UT_METHOD( FormatterJavaStyle )
{
    ...
    //===== Hash value 'h'/'H' =========
    AString tExpect;
    tExpect._() << Format::Hex(reinterpret_cast<uinteger>( &formatterJS ) ) ;
    checkFormat(ut, tExpect.ToLower()         , "%h"               , &formatterJS  );
    checkFormat(ut, tExpect.ToUpper()         , "%H"               , &formatterJS  );

    //===== Date/Time 't'/'T' =========
    TicksCalendarTime ctAM;
    ctAM.Year     = 2015;
    ctAM.Day      =    3;
    ctAM.Month    =    1;
    ctAM.Hour     =   05;
    ctAM.Minute   =    6;
    ctAM.Second   =    2;
    Ticks ticksAM( ctAM.Get() );

    TicksCalendarTime ctPM;
    ctPM.Year     = 2016;
    ctPM.Day      =   30;
    ctPM.Month    =    9;
    ctPM.Hour     =   14;
    ...
    checkFormat(ut,  "14"                         , "%tk"         ,ticksPM );
    checkFormat(ut,  "05 am"                      , "%tI"         ,ticksAM );
    checkFormat(ut,  "02 pm"                      , "%tI"         ,ticksPM );
    checkFormat(ut,  "5 am"                       , "%tl"         ,ticksAM );
    checkFormat(ut,  "2 pm"                       , "%tl"         ,ticksPM );
    checkFormat(ut,  "06"                         , "%tM"         ,ticksAM );
    checkFormat(ut,  "18"                         , "%tM"         ,ticksPM );
    checkFormat(ut,  "02"                         , "%tS"         ,ticksAM );
    checkFormat(ut,  "22"                         , "%tS"         ,ticksPM );

    checkFormat(ut,  "January"                    , "%tB"         ,ticksAM );
    checkFormat(ut,  "September"                  , "%tB"         ,ticksPM );
    checkFormat(ut,  "Jan"                        , "%tb"         ,ticksAM );
    checkFormat(ut,  "Sep"                        , "%tb"         ,ticksPM );
    checkFormat(ut,  "Saturday"                   , "%tA"         ,ticksAM );
    checkFormat(ut,  "Friday"                     , "%tA"         ,ticksPM );
    checkFormat(ut,  "Sat"                        , "%ta"         ,ticksAM );
    checkFormat(ut,  "Fri"                        , "%ta"         ,ticksPM );
    checkFormat(ut,  "2015"                       , "%tY"         ,ticksAM );
    checkFormat(ut,  "2016"                       , "%tY"         ,ticksPM );
    checkFormat(ut,  "15"                         , "%ty"         ,ticksAM );
    checkFormat(ut,  "16"                         , "%ty"         ,ticksPM );
    checkFormat(ut,  "01"                         , "%tm"         ,ticksAM );
    checkFormat(ut,  "09"                         , "%tm"         ,ticksPM );
    checkFormat(ut,  "03"                         , "%td"         ,ticksAM );
    checkFormat(ut,  "30"                         , "%td"         ,ticksPM );
    checkFormat(ut,  "3"                          , "%te"         ,ticksAM );
    checkFormat(ut,  "30"                         , "%te"         ,ticksPM );

    checkFormat(ut,  "05:06"                      , "%tR"         ,ticksAM );
    checkFormat(ut,  "14:18"                      , "%tR"         ,ticksPM );
    checkFormat(ut,  "05:06:02"                   , "%tT"         ,ticksAM );
    checkFormat(ut,  "14:18:22"                   , "%tT"         ,ticksPM );

    checkFormat(ut,  "01/03/15"                   , "%tD"         ,ticksAM );
    checkFormat(ut,  "09/30/16"                   , "%tD"         ,ticksPM );
    checkFormat(ut,  "2015-01-03"                 , "%tF"         ,ticksAM );
    checkFormat(ut,  "2016-09-30"                 , "%tF"         ,ticksPM );
    ...
    checkFormat(ut,  String64()._(L"    \u03B1")  , "%5c"        , L'\u03B1'    ); //greek alpha
    checkFormat(ut,  String64('a')<<L"\u03B1"<<'b' << L"\u03B2", "a%cb%c"   , L'\u03B1', L'\u03B2'    ); //greek alpha, beta
    checkFormat(ut,  "@"                          , "%c"         , 64           ); // int   ascii @
    checkFormat(ut,  "@"                          , "%c"         , 64L          ); // long  ascii @
    checkFormat(ut,  "@"                          , "%c"         , 64UL         ); // ulong ascii @
    checkFormat(ut,  String64()._(L"\u03B1")      , "%c"         , 0x03B1       ); //greek alpha
    checkFormat(ut,  String64()._(L"\u03B1")      , "%c"         , 0x03B1L      ); //greek alpha
    checkFormat(ut,  String64()._(L"\u03B1")      , "%c"         , 0x03B1UL     ); //greek alpha
...
UT_METHOD( FormatterPythonStyle )
{
    ...
    checkFormat(ut,  "2016-09-05 14:05:22"       , "{:yyyy-MM-dd HH:mm:ss}"         ,ticks);
    ...
    //================================== Mixed tests ==============================================
    {
        ...
        AString as;   as << c << '/' << sChar << '/' << uChar << '/' << sChar2; UT_EQ( "x/121/122/-5", as );
    ...
    AString testBuf; testBuf._(L"\u03B1\u03B2\u03B3");
    checkFormat(ut,  testBuf.ToCString()  , "{:.4s}"       , L"\u03B1\u03B2\u03B3"    );
    checkFormat(ut,  testBuf.ToCString()  , "{:.3s}"       , L"\u03B1\u03B2\u03B3"    );
    testBuf._()._(L"\u03B1\u03B2");
    checkFormat(ut,  testBuf.ToCString()  , "{:.2s}"       , L"\u03B1\u03B2\u03B3"    );
    testBuf._()._(L"\u03B1");
    checkFormat(ut,  testBuf.ToCString()  , "{:.1s}"       , L"\u03B1\u03B2\u03B3"    );
