...
class LogTools
{
    ...
    public:
         ...
         * \ref aworx::lox::Lox::SetDomain "SetDomain( domainPrefix, Scope::ThreadOuter )" and
         * \ref aworx::lox::Lox::SetPrefix "SetPrefix( logPrefix, Scope::ThreadOuter )".
...
using     LogTools=           aworx::lox::LogTools;
