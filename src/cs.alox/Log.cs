...
public static class Log
{
    ...
    public enum Scope
    {
        ...
        /// <summary> The error handler for the AWXU package. An instance of this class will be created
        /// statically and added to AWXU to replace the default console error handler there. </summary>
        public class    ALoxAWXUErrorHandler : AWXUErrorHandler
        {
             ...
             **************************************************************************************/
            public void error  ( string msg )    { Log.Error     ( "AWXU", msg ); }
            /** ************************************************************************************
             * <summary> Report an AWXU warning using ALox. </summary>
             * <param name="msg">    The warning message. </param>
             **************************************************************************************/
            public void warning( string msg )    { Log.Warning( "AWXU", msg ); }
        }
    ...
    /** ********************************************************************************************
     * <summary>
     *  Returns a AString singleton (contained in the Lox singleton), that can be reused for all basic
