...
public class LogTools
{
...

    {
        ...
        protected static void exception( Exception e, String headline, int indent )
        {
            ...
            /** ************************************************************************************
             * <summary> Logs the header and invokes instRecursive() </summary>
             * <param name="o">              The object to be logged. </param>
             * <param name="maxRecursion">   The maximum depth of recursion for logging nested object. </param>
             * <param name="headLine">       The headline to log. </param>
             **************************************************************************************/
             ...
             * <param name="maxRecursion">   The maximum depth of recursion for logging nested 
             *                               object. </param>
             * <param name="indent">         The indentation in the output (recursively increased).
             *                               </param>
             **************************************************************************************/
...
//                    else
             ...
             * <param name="type">    The type of the object (needed outside, therefore passed here 
