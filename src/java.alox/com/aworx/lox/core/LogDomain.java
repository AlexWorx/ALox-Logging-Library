...
//#if ALOX_DEBUG || ALOX_REL_LOG
     ...
     * @param createIfNotExistent   If set true, domains in the path that are not found are created.
     *
     * @return  The domain found or created.
     **********************************************************************************************/
    public LogDomain findOrCreate( AString domainPath, boolean createIfNotExistent)
    {
    ...
    protected LogDomain findOrCreateInternal( AString    domainPath,    int dpStartIdx, boolean createIfNotExistent)
    {
