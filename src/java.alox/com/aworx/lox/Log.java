...
public abstract class Log
{
    ...
    // #############################################################################################
        ...
        static
        {
            class ALoxAWXUErrorHandler implements AWXUErrorHandler
            {
                ...
                {
                    Log.warning( "AWXU", msg );
                }
            }

            AWXU.replaceErrorHandler( new ALoxAWXUErrorHandler() );
    ...
    {
        LOX.addLogger( logger, Log.DomainLevel.WARNINGS_AND_ERRORS );
    }
     ...
     **********************************************************************************************/
    public static void addLogger(Logger logger, Log.DomainLevel internalDomainLevel)
    {
        LOX.addLogger( logger, internalDomainLevel );
    }
     ...
     *                      scenarios.
     **********************************************************************************************/
    public static void setDomain(String domain, Log.DomainLevel domainLevel, boolean recursive, String loggerFilter)
    {
        LOX.setDomain( domain, domainLevel, recursive, loggerFilter );
    }
     ...
     * @param recursive     Set sub domains recursively. Defaults to true.
     **********************************************************************************************/
    public static void setDomain(String domain, Log.DomainLevel domainLevel, boolean recursive)
    {
        LOX.setDomain( domain, domainLevel, recursive, null );
    }
    ...
    {
        LOX.setDomain( domain, domainLevel, true, null );
    }
     ...
     *                      scenarios.
     **********************************************************************************************/
    public static void setDisabled(boolean disabled, String loggerFilter)
    {
        LOX.setDisabled( disabled, loggerFilter );
    }
