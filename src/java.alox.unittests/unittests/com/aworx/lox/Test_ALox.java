...
public class Test_ALox
{
    ...
    public void Log_TestTextLoggerTimeDiff()
    {
        ...
        {
            public       void     t( AString buf, long diff )         { writeTimeDiffx( buf, diff ); }
        }
        ...
        t.timeDiffMinimum= 0;
        diff= 0;                            ms.clear(); t.t( ms, diff ); assertEquals(  "000" + t.timeDiffNanos,    ms.toString(0,  ms.length() ) );
        diff= 15;                           ms.clear(); t.t( ms, diff ); assertEquals(  "015" + t.timeDiffNanos,    ms.toString(0,  ms.length() ) );
        diff= 99;                           ms.clear(); t.t( ms, diff ); assertEquals(  "099" + t.timeDiffNanos,    ms.toString(0,  ms.length() ) );
        diff= 600;                          ms.clear(); t.t( ms, diff ); assertEquals(  "600" + t.timeDiffNanos,    ms.toString(0,  ms.length() ) );
        diff= 999;                          ms.clear(); t.t( ms, diff ); assertEquals(  "999" + t.timeDiffNanos,    ms.toString(0,  ms.length() ) );
        diff= 1000;                         ms.clear(); t.t( ms, diff ); assertEquals(  "001" + t.timeDiffMicros,   ms.toString(0,  ms.length() ) );
        t.timeDiffMinimum= 700;
        diff= 600;                          ms.clear(); t.t( ms, diff ); assertEquals(          t.timeDiffNone,     ms.toString(0,  ms.length() ) );
        diff= 700;                          ms.clear(); t.t( ms, diff ); assertEquals(  "700" + t.timeDiffNanos,    ms.toString(0,  ms.length() ) );
        diff= 999;                          ms.clear(); t.t( ms, diff ); assertEquals(  "999" + t.timeDiffNanos,    ms.toString(0,  ms.length() ) );
        t.timeDiffMinimum= 1000;
        diff= 1000;                         ms.clear(); t.t( ms, diff ); assertEquals(  "001"  + t.timeDiffMicros,  ms.toString(0,  ms.length() ) );
        diff= 15  * micros;                 ms.clear(); t.t( ms, diff ); assertEquals(  "015"  + t.timeDiffMicros,  ms.toString(0,  ms.length() ) );
        diff= 99  * micros;                 ms.clear(); t.t( ms, diff ); assertEquals(  "099"  + t.timeDiffMicros,  ms.toString(0,  ms.length() ) );
        diff= 600 * micros;                 ms.clear(); t.t( ms, diff ); assertEquals(  "600"  + t.timeDiffMicros,  ms.toString(0,  ms.length() ) );
        diff= 999 * micros;                 ms.clear(); t.t( ms, diff ); assertEquals(  "999"  + t.timeDiffMicros,  ms.toString(0,  ms.length() ) );
...
//        diff= 99  * secs + 950 * millis;    ms.Clear(); t.t( ms, diff ); assertEquals(  "99.9" + t.fmtTimeDiffSecs,        ms.toString(0,  ms.Length ) );
    ...
    public void Log_TestDefaultDomain()
    {
        ...
        public void Log_TestLineFormat()
        {
            ...
            AString  lf;
            lf= new AString( "(%CF) %CP.%CC.%CM():%A3[%D][%TD][%TE +%TI] [%t] %L [%O] <%#>: ");    cl.lineFormatter.format= lf;    Log.info( "LineFormat set to= \"" + lf + "\"" );
            lf= new AString(     "(%CF) %CC.%CM():%A3[%D][%TD][%TE +%TI] [%t] %L [%O] <%#>: ");    cl.lineFormatter.format= lf;    Log.info( "LineFormat set to= \"" + lf + "\"" );
            lf= new AString(         "(%CF) %CM():%A3[%D][%TD][%TE +%TI] [%t] %L [%O] <%#>: ");    cl.lineFormatter.format= lf;    Log.info( "LineFormat set to= \"" + lf + "\"" );
            lf= new AString(         "(%CF) %CM():%A3[%TD][%TE +%TI] [%t] %L [%O] <%#>: ");        cl.lineFormatter.format= lf;    Log.info( "LineFormat set to= \"" + lf + "\"" );
            lf= new AString(         "(%CF) %CM():%A3[%TE +%TI] [%t] %L [%O] <%#>: ");             cl.lineFormatter.format= lf;    Log.info( "LineFormat set to= \"" + lf + "\"" );
            lf= new AString(         "(%CF) %CM():%A3[+%TI] [%t] %L [%O] <%#>: ");                 cl.lineFormatter.format= lf;    Log.info( "LineFormat set to= \"" + lf + "\"" );
            lf= new AString(         "(%CF) %CM():%A3[%t] %L [%O] <%#>: ");                        cl.lineFormatter.format= lf;    Log.info( "LineFormat set to= \"" + lf + "\"" );
            lf= new AString(         "(%CF) %CM():%A3%L [%O] <%#>: ");                             cl.lineFormatter.format= lf;    Log.info( "LineFormat set to= \"" + lf + "\"" );
            lf= new AString(         "(%CF) %CM():%A3[%O] <%#>: ");                                cl.lineFormatter.format= lf;    Log.info( "LineFormat set to= \"" + lf + "\"" );
            lf= new AString(         "(%CF) %CM():%A3[%O]: ");                                     cl.lineFormatter.format= lf;    Log.info( "LineFormat set to= \"" + lf + "\"" );
        ...
        public void Log_TestMarker()
        {
            ...
            marker= Log.getMarker( Log.Scope.NONE );    Log.info( "The current global        marker is: " + marker );     assertTrue( (String) marker == markerGlobal    );
            marker= Log.getMarker( Log.Scope.PACKAGE ); Log.info( "The current package level marker is: " + marker );     assertTrue( (String) marker == markerPkg        );
            marker= Log.getMarker( Log.Scope.CLASS );   Log.info( "The current class   level marker is: " + marker );     assertTrue( (String) marker == markerClass        );
            marker= Log.getMarker( Log.Scope.METHOD );  Log.info( "The current method  level marker is: " + marker );     assertTrue( (String) marker == markerMethod    );
        }
