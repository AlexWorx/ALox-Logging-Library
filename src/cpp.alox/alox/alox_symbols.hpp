...
#ifndef HPP_AWORX_ALOX_ALOX_SYMBOLS
#define HPP_AWORX_ALOX_ALOX_SYMBOLS 1
 ...
 *
 * For most of them, a version with a postfix "_ON" and "_OFF" exists. If both are set at the same
 ...
 *
 * ALox inherits further compiler symbols from underlying library AWXU. These are documented in:
 ...
 *  caller source information for debug logging.
 *
...
#endif // HPP_AWORX_ALOX_ALOX_SYMBOLS
