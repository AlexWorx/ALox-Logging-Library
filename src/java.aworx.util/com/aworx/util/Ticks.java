 ...
 public class Ticks
{
    ...
    // #############################################################################################
         ...
         * raw() method. (Well, in the Java implementation of AWXU it currently does.)
         ******************************************************************************************/
        public static long         internalFrequency()        {    return internalFrequency; }


        /** ****************************************************************************************
         *  @return The point in time when the ticker library (AWXU) was initialized. This might be
