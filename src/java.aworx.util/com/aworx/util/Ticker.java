 ...
 * 
 * Ticks generated by this class can be added and substracted:
 * 
 * - Substraction generates a *span value in ticks*
 * - *Span value in ticks* can be added to themselves  safely
 * - *Span value in ticks* can be added to ticks safely  
 * 
 * Conversion functins to milliseconds, microseconds and nanoseconds accept ticks and span
 ...
 * this class and class *TickTime* (See class #TickTime for a non-static implementation of this
