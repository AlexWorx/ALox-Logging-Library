 ...
 * - \ref cs::aworx::lib::strings::FormatterPythonStyle  "FormatterPythonStyle", which mimics
 *   the [Python formatting syntax](https://docs.python.org/3.5/library/string.html#format-string-syntax)
 *   and
 * - \ref cs::aworx::lib::strings::FormatterJavaStyle    "FormatterJavaStyle", which mimics
 ...
 * With class
 * \ref cs::aworx::lib::strings::FormatterStdImpl "FormatterStdImpl" a - still abstract -
 ...
 * \ref cs::aworx::lib::strings::FormatterPythonStyle  "FormatterPythonStyle" and
 * \ref cs::aworx::lib::strings::FormatterJavaStyle    "FormatterJavaStyle" derive from
...
public abstract class Formatter
{
    ...
    // #############################################################################################
         ...
         *******************************************************************************************/
        public virtual
        void    FormatList( AString target, Object[]  args )
        {
            if (boxes == null)
                boxes = new List<Object>();
            else
         ...
         *******************************************************************************************/
        public virtual
        void    FormatList( AString target, List<Object> args )
        {
