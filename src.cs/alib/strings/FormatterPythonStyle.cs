...
/** ************************************************************************************************
 * Implements a \ref cs::aworx::lib::strings::Formatter "Formatter" according to the
 ...
 *   to consult the \ref cs::aworx::lib::strings::FormatterStdImpl "parent classes documentation".
 *
 ...
 *     \ref cs::aworx::lib::strings::FormatterStdImpl "FormatterStdImpl", features of the parent are
 ...
 *     \ref cs::aworx::lib::strings::FormatterStdImpl::AlternativeNumberFormat "AlternativeNumberFormat"
 ...
 *     \ref cs::aworx::lib::strings::FormatterStdImpl::DefaultNumberFormat "DefaultNumberFormat",
 ...
 *     \ref cs::aworx::lib::strings::FormatterStdImpl::DefaultNumberFormat "DefaultNumberFormat" apply.
 ...
 *   \ref cs::aworx::lib::strings::FormatterStdImpl "FormatterStdImpl".
 *
 * <p>
 * - <b>Conversions:</b><br>
 ...
 *     \ref cs::aworx::lib::strings::Formatter::FormatList "Formatter.FormatList" the
 ...
 *     by invoking method
 *     \ref cs::aworx::lib::strings::AutoSizes::Reset "Reset" on field #TabSizes.
 **************************************************************************************************/
public class FormatterPythonStyle : FormatterStdImpl
{
    ...
    // #############################################################################################
         ...
         * \ref cs::aworx::lib::strings::Formatter::FormatList "Formatter.FormatList".
         ******************************************************************************************/
         ...
         * \ref cs::aworx::lib::strings::FormatterStdImpl::phaFormatSpec "Formatter.phaFormatSpec".
         *
