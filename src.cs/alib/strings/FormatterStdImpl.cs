 ...
 * \ref cs::aworx::lib::strings::Formatter::format "Formatter.format" and introduces a set of
 ...
 *   \ref cs::aworx::lib::strings::FormatterPythonStyle "FormatterPythonStyle" as the
 *   "Python format mini language" supports such custom format specifications. Class
 *   \ref cs::aworx::lib::strings::FormatterJavaStyle "FormatterJavaStyle" does \b not support
 *   this mechanism.
 *
 ...
 *     substring in field
 *     \ref cs::aworx::lib::strings::FormatterStdImpl::phaFormatSpec "phaFormatSpec".
 *
 ...
 *       set fields
 *       \ref cs::aworx::lib::strings::FormatterStdImpl::phaArgument    "phaArgument" and
 *       \ref cs::aworx::lib::strings::FormatterStdImpl::phaArgumentIdx "phaArgumentIdx"
...
public abstract class FormatterStdImpl : Formatter
{
    ...
    // #############################################################################################
         ...
         *  This is set to
         *  \ref cs::aworx::lib::strings::FormatterStdImpl::PHType::NotGiven "PHType.NotGiven"
    ...
    // #############################################################################################
         ...
         * \ref cs::aworx::lib::strings::FormatterStdImpl::phaArgument "phaArgument"
         ...
         * \ref cs::aworx::lib::strings::FormatterStdImpl::phaArgument    "Argument" and
         * \ref cs::aworx::lib::strings::FormatterStdImpl::phaArgumentIdx "ArgumentIdx"
         * in given \p field.
