 ...
 * to the C++ language to be placed in namespace \ref cs.aworx.lib.lang.
 **************************************************************************************************/
namespace cs.aworx.lib.util  {
 ...
 * Those are:
 * - \ref cs.aworx.lib.util.StringTree.Cursor       "Cursor" and
 * - \ref cs.aworx.lib.util.StringTree.Walker       "Walker".
 *
 ...
 * \ref cs.aworx.lib.util.StringTree.Cursor "Cursor". The only way to create an
 ...
 * - \ref cs.aworx.lib.util.StringTree.Cursor.MoveToChild        "Cursor.MoveToChild",
 * - \ref cs.aworx.lib.util.StringTree.Cursor.MoveToParent       "Cursor.MoveToParent",
 * - \ref cs.aworx.lib.util.StringTree.Cursor.MoveTo             "Cursor.MoveTo" and
 * - \ref cs.aworx.lib.util.StringTree.Cursor.MoveToExistingPart "Cursor.MoveToExistingPart".
 *
 * For the creation of new child nodes or a complete path of such, methods
 * - \ref cs.aworx.lib.util.StringTree.Cursor.MoveToChildCreate              "Cursor.MoveToChildCreate" and
 * - \ref cs.aworx.lib.util.StringTree.Cursor.MoveToAndCreateNonExistingPart "Cursor.MoveToAndCreateNonExistingPart"
 *
 * are provided. Then, two methods for erasing nodes exist:
 * - \ref cs.aworx.lib.util.StringTree.Cursor.DeleteChild    "Cursor.DeleteChild" and
 * - \ref cs.aworx.lib.util.StringTree.Cursor.DeleteChildren "Cursor.DeleteChildren"
 *
 ...
 * - \ref cs.aworx.lib.util.StringTree.Cursor.MoveToParentUnchecked "Cursor.MoveToParentUnchecked" and
 * - \ref cs.aworx.lib.util.StringTree.Cursor.IsValid               "Cursor.IsValid".
 *
 ...
 * Finally, with
 * \ref cs.aworx.lib.util.StringTree.Walker "Walker", a third \b %StdIterator class is exposed.
 ...
 *   \ref cs.aworx.lib.util.StringTree.Cursor   "Cursor"   objects
 ...
 * \ref cs.aworx.lib.util.StringTree.Walker.SetRecursionDepth "Walker.SetRecursionDepth".
 ...
 * Objects of types
 * \ref cs.aworx.lib.util.StringTree.Cursor "Cursor" and
 * \ref cs.aworx.lib.util.StringTree.Walker "Walker" may become invalid when
...
public class StringTree<T>
{
    ...
    // #############################################################################################
         ...
         * \ref cs.aworx.lib.util.StringTree.Cursor "Cursor", which represents node objects,
    ...
    // #############################################################################################
        ...
        public class Cursor
        {
            ...
            //####  Protected methods (class Cursor)  ############################################
                 ...
                 *   \ref cs.aworx.lib.util.StringTree.Walker "Walker" can access it.
            ...
            //####  Tree navigation inplace, returning status      #################################
                 ...
                 *    \snippet "alib/util/StringTree.cs"     DOX_ALIB_STRING_TREE_MOVETOPARENT
                 *
...
//! [DOX_ALIB_STRING_TREE_MOVETOPARENT]
         ...
         * \ref cs.aworx.lib.util.StringTree "StringTree".
         ******************************************************************************************/
        public class Walker
        {
            //######################################################################################
            ...
            //######################################################################################
              	...
              	public class Sorter
                {
                     ...
                     * \ref cs.aworx.lib.util.StringTree.Walker.RecursionData.reset "RecursionData.reset".
            ...
            //######################################################################################
                 ...
                 *
                 * \note Unlike method
                 *       \ref cs.aworx.lib.util.StringTree.Cursor.SearchName "Cursor.SearchName"
                 ...
                 * #GetCursor and
                 * \ref cs.aworx.lib.util.StringTree.Cursor.Depth "Cursor.Depth".
                 *
