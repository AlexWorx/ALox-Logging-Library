 ...
 * \ref com::aworx::lib::strings::Formatter::format "Formatter.format" and introduces a set of
 ...
 *   \ref com::aworx::lib::strings::FormatterPythonStyle "FormatterPythonStyle" as the
 *   "Python format mini language" supports such custom format specifications. Class
 *   \ref com::aworx::lib::strings::FormatterJavaStyle "FormatterJavaStyle" does \b not support
 *   this mechanism.
 *
 ...
 *     substring in field
 *     \ref com::aworx::lib::strings::FormatterStdImpl::phaFormatSpec "phaFormatSpec".
 *
 ...
 *       set fields
 *       \ref com::aworx::lib::strings::FormatterStdImpl::phaArgument    "phaArgument" and
 *       \ref com::aworx::lib::strings::FormatterStdImpl::phaArgumentIdx "phaArgumentIdx"
...
public abstract class FormatterStdImpl extends Formatter
{
    ...
    /** The type of the attribute as specified in the placeholder.
         *  This is set to
         *  \ref com::aworx::lib::strings::FormatterStdImpl::PHType::NotGiven "PHType.NotGiven"
    ...
    // #############################################################################################
         ...
         * \ref com::aworx::lib::strings::FormatterStdImpl::phaArgument    "Argument" and
         * \ref com::aworx::lib::strings::FormatterStdImpl::phaArgumentIdx "ArgumentIdx"
         * in given \p field.
