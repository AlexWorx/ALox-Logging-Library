 ...
 *   \ref com::aworx::lib::strings::FormatterStdImpl::DefaultNumberFormat "FormatterStdImpl.DefaultNumberFormat".
 ...
 **************************************************************************************************/
public class FormatterJavaStyle extends com.aworx.lib.strings.FormatterStdImpl
{
    // #############################################################################################
    // Protected fields
    // #############################################################################################
    ...
    // #############################################################################################
        ...
        protected void    replaceEscapeSequences( int startIdx )
        {
            ...
            ptargetString.searchAndReplace( "%n" , com.aworx.lib.strings.CString.NEW_LINE_CHARS , startIdx );
