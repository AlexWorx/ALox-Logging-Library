 ...
 * \ref com::aworx::lib::containers::StringTree::Node "Node", which consists of
 ...
 * Those are:
 * - \ref com::aworx::lib::containers::StringTree::Cursor       "Cursor" and
 * - \ref com::aworx::lib::containers::StringTree::Walker       "Walker".
 *
 ...
 * \ref com::aworx::lib::containers::StringTree::Cursor "Cursor". The only way to create an
 ...
 * - \ref com::aworx::lib::containers::StringTree::Cursor::moveToChild        "Cursor.moveToChild",
 * - \ref com::aworx::lib::containers::StringTree::Cursor::moveToParent       "Cursor.moveToParent",
 * - \ref com::aworx::lib::containers::StringTree::Cursor::moveTo             "Cursor.moveTo" and
 * - \ref com::aworx::lib::containers::StringTree::Cursor::moveToExistingPart "Cursor.moveToExistingPart".
 *
 * For the creation of new child nodes or a complete path of such, methods
 * - \ref com::aworx::lib::containers::StringTree::Cursor::moveToChildCreate              "Cursor.moveToChildCreate" and
 * - \ref com::aworx::lib::containers::StringTree::Cursor::moveToAndCreateNonExistingPart "Cursor.moveToAndCreateNonExistingPart"
 *
 * are provided. Then, two methods for erasing nodes exist:
 * - \ref com::aworx::lib::containers::StringTree::Cursor::deleteChild    "Cursor.deleteChild" and
 * - \ref com::aworx::lib::containers::StringTree::Cursor::deleteChildren "Cursor.deleteChildren"
 *
 ...
 * - \ref com::aworx::lib::containers::StringTree::Cursor::moveToParentUnchecked "Cursor.moveToParentUnchecked" and
 * - \ref com::aworx::lib::containers::StringTree::Cursor::isValid               "Cursor.isValid".
 *
 ...
 * Finally, with
 * \ref com::aworx::lib::containers::StringTree::Walker "Walker", a third \b %StdIterator class is exposed.
 ...
 *   \ref com::aworx::lib::containers::StringTree::Cursor "Cursor" objects.
 ...
 * \ref com::aworx::lib::containers::StringTree::Walker::setRecursionDepth "Walker.setRecursionDepth".
 ...
 * Objects of types
 * \ref com::aworx::lib::containers::StringTree::Cursor "Cursor" and
 * \ref com::aworx::lib::containers::StringTree::Walker "Walker" may become invalid when
...
public class StringTree<T>
{
    ...
    // #############################################################################################
         ...
         * \ref com::aworx::lib::containers::StringTree::Cursor "Cursor", which represents node objects,
    ...
    // #############################################################################################
        ...
        public class Cursor
        {
            ...
            //####  Constructor, comparison operators, etc     #####################################
                 ...
                 *   reasons, i.e. that inner sibling class
                 *   \ref com::aworx::lib::containers::StringTree::Walker "Walker" can access it.
                 * @return The \b %StringTree object.
                 */
            ...
            //####  Tree navigation inplace, returning status      #################################
                 ...
                 *    \snippet "alib/com/aworx/lib/containers/StringTree.java"     DOX_ALIB_STRING_TREE_MOVETOPARENT
                 *
...
//! [DOX_ALIB_STRING_TREE_MOVETOPARENT]
         ...
         * \ref com::aworx::lib::containers::StringTree "StringTree".
         ******************************************************************************************/
        public class Walker
        {
            //######################################################################################
            ...
            //######################################################################################
                 ...
                 *
                 * \note Unlike method
                 *       \ref com::aworx::lib::containers::StringTree::Cursor::searchName "Cursor.searchName"
                 ...
                 * #getCursor and
                 * \ref com::aworx::lib::containers::StringTree::Cursor::depth "Cursor.depth".
                 *
