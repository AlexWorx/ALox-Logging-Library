 ...
 * - One with priority
 *   \ref com::aworx::lib::config::Configuration::PRIO_DEFAULT "PRIO_DEFAULT" (low priority)
 *   to store default values not found in other configuration plug-ins and
 * - a second with priority
 *   \ref com::aworx::lib::config::Configuration::PRIO_PROTECTED "PRIO_PROTECTED" (highest priority),
