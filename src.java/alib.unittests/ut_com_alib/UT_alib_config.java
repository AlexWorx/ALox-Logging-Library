...
public class UT_alib_config extends UnitTest
{
    //---------------------------------------------------------------------------------------------------------
    ...
    public void CommandLineArgs()
    {
        ...
        UT_EQ( 10,    cfg.get   ( null,  "SingleHyphen",  v            ) );   UT_EQ( "12",            v.toString() );
        UT_EQ( true,  cfg.isTrue( null,  "DoubleHyphen",  prio,  temp  ) );   UT_EQ( 10,              prio[0] );

        UT_EQ(  0,    cfg.get   ( null,  "Empty",         v            ) );   UT_EQ( "",              v.toString() );
        UT_EQ( 10,    cfg.get   ( null,  "Whitespaces",   v            ) );   UT_EQ( "Hello Test",    v.toString() );
        UT_EQ( 10,    cfg.get   ( null,  "HOME",          v            ) );   UT_EQ( "overwritten",   v.toString() );
        UT_EQ( 10,    cfg.get   ( null,  "integer",       iv           ) );   UT_EQ( 42,              iv[0] );
        UT_EQ(  0,    cfg.get   ( null,  "notexistant",   iv           ) );   UT_EQ( 0,               iv[0] );
        UT_EQ( 10,    cfg.get   ( null,  "integer",       iv, temp     ) );   UT_EQ( 42,              iv[0] );
        UT_EQ( 10,    cfg.get   ( null,  "double",        dv           ) );   UT_EQ( 3.14,            dv[0], 0.0 );
        UT_EQ(  0,    cfg.get   ( null,  "notexistant",   dv           ) );   UT_EQ( 0.0,             dv[0], 0.0 );
        UT_EQ( 10,    cfg.get   ( null,  "double",        dv, temp     ) );   UT_EQ( 3.14,            dv[0], 0.0 );
        UT_EQ( 10,    cfg.get   ( "ALIB", "test",        v            ) );   UT_EQ( "passed",        v.toString() );
    }
