...
public class UT_alib_threads  extends UnitTest
{
    //---------------------------------------------------------------------------------------------------------
    //--- Simple
    //---------------------------------------------------------------------------------------------------------
    ...
    {
        Log.setDomain( "TL_Simple", Log.Scope.METHOD );
        Log.info( "\n### ThreadLock_Simple ###" );
    ...
    {
        Log.setDomain( "TL_Threaded", Log.Scope.METHOD );
        Log.info( "\n### TicksBasics ###" );
    ...
    {
        Log.setDomain( "TL_HeavyLoad", Log.Scope.METHOD );
    ...
    {
        Log.setDomain( "TL_SpeedTest", Log.Scope.METHOD );
        Log.info( "\n### TicksBasics ###" );
        ThreadLock aLock= new ThreadLock();
...
public class Test_ThreadLock_TestThread extends Thread
{
    ...
    {
        Log.setDomain( "TestThread", Log.Scope.METHOD );
        for ( int i= 0; i < repeats ; i++ )
        {
