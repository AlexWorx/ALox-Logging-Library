...
public class UT_alib_time  extends UnitTest
{
    @SuppressWarnings("static-method")
    @Test
    public void Basics()
    {
        Log.setDomain( "Basics", Log.Scope.METHOD );
        Log.info( "\n### TicksBasics ###" );
    ...
    {
        Log.setDomain( "SpeedTest", Log.Scope.METHOD );
    ...
    {
        Log.setDomain( "DtTmConv", Log.Scope.METHOD );
    ...
    public void Ages()
    {
        Log.setDomain( "Ages", Log.Scope.METHOD );
    ...
    {
        Log.setDomain( "Measure", Log.Scope.METHOD );
